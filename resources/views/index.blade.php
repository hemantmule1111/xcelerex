...
<head>
    ...
    <!-- Favicon -->
    <!--<link rel="icon" href="../../public/dashboard/assets/images/favicon.png">-->
...
<body>
    ...
    <nav id="navbar" class="navbar navbar-expand-lg fixed-top navbar-dark" aria-label="Main navigation">
        <div class="container">
            ...
            <a class="navbar-brand logo-text" href="index.html">XcelereX</a>
        ...
        <div class="container" >
            <div class="row d-flex align-items-center">
                ...
                <div class="col-lg-5 text-center py-4 py-sm-0" data-aos="fade-down"> 
                    <img class="img-fluid" src="../../public/dashboard/assets/images/about.jpg" alt="about" >
                </div>
            </div> <!-- end of row -->
        </div> <!-- end of container -->
            ...
            <div class="row gy-4 py-2" data-aos="zoom-in">
                <div class="col-lg-4">
                    <div class="card bg-transparent">
                        ...
                        <h4 class="py-2">Product Engineering</h4>
                        <p class="para-light"> <ul>
                            <li>Technology and industry agnostic</li>
                            <li>Unmatched capabilities across the entire product life cycle</li> <br>
                            <li>Multiple industry specialization, including retail, food and beverage, CPG, finance, travel and entertainment</li>
                        </ul>
                        </p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="card bg-transparent">
                        ...
                        <h4 class="py-2">Business Intelligence</h4>
                        <p class="para-light"> <ul>
                            <li>Data Warehousing & Data Mart Design</li><br>
                            <li>Decision Support Systems – KRI KPI Dashboard, Data Reporting</li><br>
                            <li>Predictive Analytics</li><br>
                        </ul>
                        </p>
                    </div>                    
                </div>
                <div class="col-lg-4">
                    <div class="card bg-transparent">
                        ...
                        <h4 class="py-2">Software Testing</h4>
                        <p class="para-light"><ul>
                            <li>Functional, Regression, Test Automation.</li>
                            <li>Load, Performance & Stress</li><br>
                            <li>Non-Functional Testing - Load, Performance, Vulnerability, and Accessibility</li>
                        </ul></p>
                    </div>                    
                </div>
                <div class="col-lg-4">
                    <div class="card bg-transparent">
                        ...
                        <h4 class="py-2">Sustenance Services</h4>
                        <p class="para-light"><ul>
                            <li>Functional, Regression, Application Life Cycle Management</li><br>
                            <li>Platform and Software Application Managed Services</li>
                        </ul></p>
                    </div>                    
                </div>
                <div class="col-lg-4">
                    <div class="card bg-transparent">
                        ...
                        <p class="para-light"><ul>
                            <li>Cloud Infrastructure Management</li><br>
                ...
                <div class="col-lg-4">
                    <div class="card bg-transparent">
                        ...
                        <p class="para-light"><ul>
                            <li>Cloud Development and Maintenance</li><br>
        ...
        <div class="container-fluid text-light">
            <div class="row">
                <div class="col-lg-6 d-flex align-items-center" data-aos="fade-right">
                    <img class="img-fluid" src="../../public/dashboard/assets/images/work.jpg" alt="work">        
                </div>
    ...
    <section class="contact d-flex align-items-center py-5" id="contact">
        <div class="container-fluid text-light">
            <div class="row">
                ...
                <div class="col-lg-6 d-flex align-items-center" data-aos="fade-down">
                    <img class="img-fluid d-none d-lg-block" src="../../public/dashboard/assets/images/contact.jpg" alt="contact">        
                </div> <!-- end of col -->
            </div> <!-- end of row -->
        </div> <!-- end of container -->
    ...
    <button onclick="topFunction()" id="myBtn">
        <img src="../../public/dashboard/assets/images/up-arrow.png" alt="alternative">
    </button>
